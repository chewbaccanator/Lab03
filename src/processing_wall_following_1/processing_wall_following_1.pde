...
void setup() {
  ...
  out.println("t_ms,photo,leftTicks,rightTicks,dLeft,dRight,mode,cmd,leftPWM,rightPWM,frontCm,rightCm,wallState");
}
...
void draw() {
  background(255);
  fill(0);
  text("CLICK THIS WINDOW FIRST, then use: m=manual, u=wall-follow, f=follow-me, w/a/s/d drive, space=stop, q=quit", 10, 30);
